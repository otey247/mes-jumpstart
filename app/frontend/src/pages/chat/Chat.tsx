            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <span className={styles.chatEmptyObjectives}>
                                <i>Modern Enterprise Search uses AI. Check for mistakes.   </i><a href="https://github.com/otey247/MES-JumpStart/blob/main/docs/transparency.md" target="_blank" rel="noopener noreferrer">Transparency Note</a>
                            </span>
                    ...
                    <div className={styles.chatInput}>
                        ...
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What are the token limits and area availability by Azure OpenAI Service, provided as a table?)"
                            disabled={isLoading}
